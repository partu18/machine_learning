...
def add_features(X,hams_features,spams_features):
...
if __name__ == '__main__':
    ...
    "Procesando emails"
    spams_features, hams_features, spams_text, hams_text = features_extraction()
    ...
    if 'antes' in args.decomposition:
        ...
        X = add_features(X,hams_features,spams_features)
